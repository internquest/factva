...
const Faq = () => {
    return (
        ...
        <header data-framer-name="Content Section 02" name="Content Section 02" class="box-border [-webkit-font-smoothing:inherit] place-content-center items-center flex flex-[0_0_auto] bg-[#f7f6f2] [flex-flow:column] gap-0 h-min overflow-hidden b9214:pt-[90px] b9214:px-[30px] b9214:pb-[100px] pt-[90px] px-[30px] pb-[100px] relative w-full">
            <div data-framer-name="Container" name="Container" class="box-border [-webkit-font-smoothing:inherit] items-center flex flex-[0_0_auto] [flex-flow:row] h-min max-w-[98%] overflow-visible p-0 relative w-full b9214:gap-[40px] gap b9214:justify-center justify-between">
                <div data-framer-name="Content area" name="Content area" class="box-border [-webkit-font-smoothing:inherit] items-start flex b9214:flex-[1_0_0px] [flex-flow:column] b9214:gap-[50px] gap-[60px] h-min b9214:max-w-[480px] max-w-[680px] overflow-hidden p-0 relative b9214:w-px w-[50%]">
                    <div data-framer-name="Title" name="Title" class="box-border [-webkit-font-smoothing:inherit] items-start flex flex-[0_0_auto] [flex-flow:column] gap-[10px] h-min overflow-hidden p-0 relative w-full">
                        <div data-framer-component-type="RichTextContainer" class="box-border [-webkit-font-smoothing:inherit] relative flex-[0_0_auto] h-auto [transform:perspective(1200px)] whitespace-pre-wrap w-full break-words outline-[none] flex flex-col justify-start flex-shrink-0 opacity-100">
                            <h2 data-styles-preset="nJtNjSFCn" class="text-primary font-semibold leading-[1.3em] tracking-[-.1px] text-start text-[56px]">WE HELP YOU TO GET FREEDOM OF ELECTRICY.</h2>
                        </div>
                ...
                <div data-framer-name="Content image" name="Content image" class="box-border [-webkit-font-smoothing:inherit] items-start flex flex-[0_0_auto] [flex-flow:column] gap-[10px] h-min overflow-visible b9214:pl-0 b9214:pr-[30px] b9214:py-0 pt-0 pr-[50px] pb-0 pl-0 relative w-min">
                    <div data-framer-name="Image" name="Image" class="box-border [-webkit-font-smoothing:inherit] [aspect-ratio:0.8_/_1] flex-[0_0_auto] h-auto relative [transform:perspective(1200px)] b9214:w-[350px] w-[492px] z-[2] opacity-100">
                        <div data-framer-background-image-wrapper="true" class="box-border [-webkit-font-smoothing:inherit] absolute [border-radius:inherit]">
                            ...
                            <img decoding="async" sizes="492px" srcset="https://framerusercontent.com/images/d5pSt7kmIFdpQtfF0OpqYJJNdY.png?scale-down-to=1024 948w, https://framerusercontent.com/images/d5pSt7kmIFdpQtfF0OpqYJJNdY.png 1130w" src="https://framerusercontent.com/images/d5pSt7kmIFdpQtfF0OpqYJJNdY.png" alt="" loading="lazy" class="box-border [-webkit-font-smoothing:inherit] b9214:hidden block w-full h-full [border-radius:inherit] object-cover"></img>
                        </div>
                    </div>
                    <div data-framer-name="Shape" name="Shape" class="box-border [-webkit-font-smoothing:inherit] [aspect-ratio:0.791803_/_1] b9214:-bottom-[30px] -bottom-[45px] flex-[0_0_auto] h-auto absolute right-0 [transform:perspective(1200px)] b9214:w-[250px] w-[424px] z-[1] opacity-100">
                    ...
                    <div data-framer-name="Pattern" name="Pattern" class="box-border [-webkit-font-smoothing:inherit] [aspect-ratio:1.32119_/_1] b9214:-bottom-[45px] -bottom-[-70px] flex-[0_0_auto] h-auto absolute b9214:right-[60px] right-[142px] [transform:perspective(1200px)] b9214:w-[280px] w-[310px] z-[1] opacity-100">
